...
#define SLPSharedHTTPRequestManager [SLPHTTPRequestManager sharedInstance]

@interface SLPHTTPRequestManager : NSObject

@property (nonatomic,readonly) NSString *sid;
@property (nonatomic,readonly) NSString *urlString;
@property (nonatomic,readonly) NSString *channelID;

+(SLPHTTPRequestManager*)sharedInstance;
